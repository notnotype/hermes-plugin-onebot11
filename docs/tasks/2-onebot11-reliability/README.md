...
- 状态：PR #12 已合并；Issue #13 的 `fix/i13-onebot11-closeout` 完成恢复顺序、authority 收紧、旧 task fencing、畸形 WS 隔离、`get_image` 输入解析和图片 preflight，本分支待创建插件 PR。Hermes strict auxiliary 与媒体合同分别保留在独立 worktree，Arch 仍未部署本轮代码。
- 开始日期：2026-08-05
