    ...
    *,
    ...
    return (
        ...
        + (
            ...
            "重命名、写入受控媒体根；runner stdout、manifest.evidence.files、仓库路径、evidence 路径、截图文件名或任意裸路径都不是媒体授权来源，"
            "不能改写成 MEDIA:；如果 mediaFiles 缺失或为空，或复制/校验失败，不得输出 MEDIA:，也不得声称图片已经发送。"
